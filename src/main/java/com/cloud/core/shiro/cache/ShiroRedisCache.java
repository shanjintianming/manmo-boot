...
import com.spring.shiro.RedisManager;
...
public class ShiroRedisCache<K, V> implements Cache<K, V>{
     ...
     * @param redisManager
     */
    public ShiroRedisCache(RedisManager redisManager, String prefix, int expire, String principalIdFieldName) {
    ...
    private String getRedisCacheKey(K key) throws Exception {
        if (key == null) {
            return null;
        }
    ...
    private String getStringRedisKey(K key) throws Exception {
        String redisKey;
    ...
    private String getRedisKeyFromPrincipalIdField(PrincipalCollection key) throws Exception {
        String redisKey;
        Object principalObject = key.getPrimaryPrincipal();
        Method pincipalIdGetter = null;
        Method[] methods = principalObject.getClass().getDeclaredMethods();
        for (Method m:methods) {
            if (ShiroRedisCacheManager.DEFAULT_PRINCIPAL_ID_FIELD_NAME.equals(this.principalIdFieldName)
